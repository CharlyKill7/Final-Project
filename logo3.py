...
class Luna(QtWidgets.QWidget):
    def __init__(self):
        ...
        # Inicializamos la variable que almacena el estado de mostrar la ventana
    ...
    while True:
        ...
        try:
            ...
            if trigger == 'logo':
                ...
                # Si se recibe el mensaje 'no_logo', cerramos la ventana si está visible
                if luna.show_window:
                    luna.close()
                    luna.closeEvent()
                ...
                # Si se recibe otro mensaje, no hacemos nada
                continue
